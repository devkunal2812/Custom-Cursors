  ...
  return (
    <section className={styles.hero}>
      ...
      <div className={styles.floatingCursors}>
        <div className={styles.cursor} style={{ top: '10%', left: '5%' }}>
          <div className={styles.cursorRing} style={{ borderColor: '#60a5fa' }}>
            <div className={styles.cursorDot} style={{ background: '#1e293b' }}></div>
          </div>
        </div>
        <div className={styles.cursor} style={{ top: '5%', left: '25%' }}>
          <div className={styles.cursorRing} style={{ borderColor: '#34d399' }}>
            <div className={styles.cursorDot} style={{ background: '#1e293b' }}></div>
          </div>
        </div>
        <div className={styles.cursor} style={{ top: '8%', right: '15%' }}>
          <div className={styles.crosshair}>
            <div className={styles.crosshairH}></div>
            <div className={styles.crosshairV}></div>
          </div>
        </div>
        <div className={styles.cursor} style={{ top: '20%', right: '8%' }}>
          <div className={styles.cursorRing} style={{ borderColor: '#60a5fa' }}>
            <div className={styles.cursorDot} style={{ background: '#1e293b' }}></div>
          </div>
        </div>
        <div className={styles.cursor} style={{ bottom: '25%', left: '8%' }}>
          <div className={styles.crosshair}>
            <div className={styles.crosshairH}></div>
            <div className={styles.crosshairV}></div>
          </div>
        </div>
        <div className={styles.cursor} style={{ bottom: '30%', left: '15%' }}>
          <div className={styles.cursorRing} style={{ borderColor: '#ec4899' }}>
            <div className={styles.cursorDot} style={{ background: '#1e293b' }}></div>
          </div>
        </div>
        <div className={styles.cursor} style={{ bottom: '20%', right: '12%' }}>
